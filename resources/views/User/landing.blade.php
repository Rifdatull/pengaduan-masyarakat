...
@section('title', 'PENGKAT - Pengaduan Masyarakat')
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">PENGKAT</h4>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Rifdatul • Smk Informatika Utama</p>
    </div>
</div>
{{-- Modal --}}
